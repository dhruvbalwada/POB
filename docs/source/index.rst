...
Why these notes when numerous books are available? 
  ...
  Also being present as a webresource we could add in interactive examples, which the readers could interact with and learn by doing. Lastly, while a lot of discussion will be centered on facts, discussions of current research topics can also be included and updated as understanding improves. 
